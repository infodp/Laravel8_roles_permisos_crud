...
(function (h) {
  ...
  function Ia(a) {
    ...
    for (f = b.length; e < f; e++) {
      if (m = b[e], r = [], !m.sType && m._sManualType) m.sType = m._sManualType;else if (!m.sType) {
        g = 0;
  ...
  function Ha(a) {
    ...
    for (l = 0; l < i.length; l++) {
      o = c[i[l]], null !== o.sWidth && (o.sWidth = Gb(o.sWidthOrig, k), r = !0);
    }

    if (d || !r && !f && !e && j == W(a) && j == n.length) for (l = 0; l < j; l++) {
      ...
      if (a.aoData.length) for (l = 0; l < i.length; l++) {
        r = i[l], o = c[r], h(Hb(a, r)).clone(!1).append(o.sContentPadding).appendTo(s);
      }
